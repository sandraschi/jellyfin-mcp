...
async def jellyfin_help(
    ...
    try:
        _tools_catalog = {
            ...
            "jellyfin_search": {
                "operations": ["search", "advanced", "people", "studios", "suggest", "saved"],
                "category": "search",
            },
            "jellyfin_playback": {
                "operations": [
            ...
            "jellyfin_streaming": {
                "operations": ["sessions", "clients", "transcode", "bandwidth", "direct_play", "remote", "lan", "kill"],
                "category": "streaming",
            },
            "jellyfin_plugin": {
                "operations": ["catalog", "list", "install", "uninstall", "enable", "disable", "configure", "update"],
                "category": "plugin",
            },
            "jellyfin_arr_stack": {
                "operations": ["status", "queue", "history", "radarr", "sonarr", "lidarr"],
                "category": "integration",
            },
            "jellyfin_subtitle": {
                "operations": ["search", "download", "upload", "delete", "sync", "offset", "provider_config"],
                "category": "subtitle",
            },
            "jellyfin_livetv": {
                "operations": [
            ...
            "jellyfin_ffmpeg": {
                "operations": ["profiles", "performance", "detect_hw", "path", "test", "benchmarks"],
                "category": "transcoding",
            },
            "jellyfin_enrichment": {
                "operations": ["tmdb", "wikipedia", "musicbrainz", "omdb", "tvdb", "batch"],
                "category": "metadata",
            },
            ...
            "jellyfin_recommend": {
                "operations": ["similar", "genre", "director", "actor", "history"],
                "category": "recommendation",
            },
            "jellyfin_integration": {
                "operations": ["export_plex", "import_plex", "sync_watchstate", "backup", "restore"],
                "category": "integration",
            },
        ...
        if operation == "discover":
            catalog = [
                {"name": k, "category": v["category"], "operations": v["operations"]} for k, v in _tools_catalog.items()
            ]
            if topic:
        ...
        if operation == "tool_help":
            if not tool_name:
                return {
                    "success": False,
                    "error": "tool_name is required for tool_help",
        ...
        if operation == "faq":
            ...
            if topic and topic in faqs:
                return {
                    ...
                    "operation": "faq",
                    "message": f"FAQ: {topic}",
                    "data": {"topic": topic, "answer": faqs[topic]},
                }
            return {
                "success": True,
                "operation": "faq",
                "message": "Frequently asked questions",
                "data": {"faqs": faqs, "topic": topic},
            }
